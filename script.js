/**
 * @param   {H.service.Platform} platform class to access HERE services
*/
...
function submitForm(event) {
  ...
  geocode(platform, start, function(startLocation) {
    geocode(platform, end, function(endLocation) {
      console.log(startLocation.lat + ',' + startLocation.lng);
      console.log(endLocation.lat + ',' + endLocation.lng);

      clearMap();

      calculateRouteFromAtoB(platform, String(startLocation.lat + ',' + startLocation.lng), String(endLocation.lat + ',' + endLocation.lng));
    });
  });
}


// Function to clear all objects from the map
function clearMap() {
